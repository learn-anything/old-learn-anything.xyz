	...
	return (
		<div>
			<div className="flex-between h-[74px] p-[20px]">
				<div className="text-[25px] text-white/30 font-semibold">Profile</div>
				<h1 className="text-white/30 font-md">Set</h1>
			</div>
			<div className="px-[41px] p-[20px] flex gap-[40px]">
				...
				<div className="col-gap-[20px]">
					<input
						...
						className="bg-[#121212] outline-none rounded-[7px] placeholder-white/20 text-white/30 w-[400px] px-[14px] p-[13px]"
					/>
					<div>
						<input
							type="text"
